<?php require '../article_navbar.php'; ?>
          ...
          <div class="conteiner">
            <div class="categories">
              ...
              <div class="article">
                <h1>What causes chronic pain ?</h1>
                <p class="small">
                ...
                <img src="../images/pain_big.jpg" class="img-fluid" alt="main-in-pain">
...
vulvodynia: chronic vulva pain that occurs with no obvious cause
                ...
                <p class="big">Who is at risk for chronic pain?</p>
                <p class="small">
...
-being overweight or obese
                ...
                <p class="big">How is chronic pain treated?</p>
                <img src="../images/pain-belly.jpg" class="img-fluid" alt="man-holding-his-belly">
                <p class="small">
...
Additionally, various lifestyle remedies are available to help ease chronic pain. Examples include:
 <ul>
   ...
   <li>meditation</li>
                ...
                <p class="big">Dealing with chronic pain</p>
                <p class="small">
                        ...
                        <div class="b1">
                            <div class="b2">
                                <a href="./Beginner’s Guide to CBD.php">
                                  ...
                                  <h1><a href="./Beginner’s Guide to CBD.php">Beginner’s Guide to CBD</a></h1>
                                  <p class="small">
