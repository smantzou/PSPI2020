<?php require '../article_navbar.php'; ?>
        ...
        <div class="conteiner">
            <div class="categories">
                ...
                <div class="article">
                    <h1>The exercise effect</h1>
                    <p class="writer">By Kirsten Weir
                        <br> December 2011, Vol 42, No. 11
                        <br> Published in American Psychological Association
                    </p>
                    <img src="../images/exercise2.jpg" class="img-fluid" alt="Image of a girl running">
                    <p class="small">
                    ...
                    <p class="big">Mood enhancement</p>
                    <p class="small">
                    ...
                    <img src="../images/bicycle-exercise.jpg" class="img-fluid" alt="Image of a man bicycling">
                    <p class="big">Buffering the brain</p>
                    <p class="small">
                    ...
                    <p class="big">Getting the payoff</p>
                    <p class="small">
       ...
       <hr class="my-4">
            <div class="categories">
               ...
               <div class="b1">
                <div class="b2">
                   <a href="./yoga.php"> 
                       <img src="../images/yoga.jpg" class="img-fluid" alt="Image of a girl doing yoga">
                   </a>
                </div>
                 <h2><a href="./yoga.php">The Relationship Between Yoga And Psychology</a></h2>
                 <p class="small">
