<?php require '../article_navbar.php'; ?>
        <div class="conteiner">
            <div class="categories">
                ...
                <div class="article">
                    <h1>The Vegetarian Diet: A Beginner's Guide and Meal Plan</h1>
                    <p class="small">
                        This article provides a beginner's guide to the vegetarian diet, including a sample meal plan for one week.
                    </p>
                    <p class="writer">By Rachael Link, MS, RD    April 18, 2020</p>
                    <img src="../images/vegetrian_diet_article.jpg" class="img-fluid" alt="Image of food">
                    <p class="small">
                    ...
                    <p class="big">What Is a Vegetarian Diet?</p>
                    <p class="small">
                    ...
                    <p class="bullets">• Lacto-ovo-vegetarian diet: Eliminates meat, fish and poultry but allows eggs and dairy products.
                    ...
                    <p class="big">May Enhance Weight Loss</p>
                    <p class="small">
                    ...
                    <p class="big">May Reduce Cancer Risk</p>
                    <p class="small">
                    ...
                    <p class="big">May Stabilize Blood Sugar</p>
                    <p class="small">
                    ...
                    <p class="big">Promotes Heart Health</p>
                    <p class="small">
                    ...
                    <p class="big">Potential Downsides</p>
                    <p class="small">
                    ...
                    <p class="bullets">• Fruits: Apples, bananas, berries, oranges, melons, pears, peaches
                    ...
                    <p class="bullets">• Meat: Beef, veal and pork
       ...
       <hr class="my-4">
            <div class="categories">
                ...
                <div class="b1">
                    <div class="b2">
                       <a href="balanced-diet.php"> 
                           <img src="../images/balanced_diet.jpg" class="img-fluid" alt="Image of fruits">
                       </a>
                    </div>
                     <h2><a href="balanced-diet.php">What is a balanced diet and how to achieve it?</a></h2>
                     <p class="small">
