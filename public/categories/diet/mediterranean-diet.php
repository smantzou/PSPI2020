<?php require '../article_navbar.php'; ?>
        <div class="conteiner">
            <div class="categories">
                ...
                <div class="article">
                    <h1>Mediterranean Diet: A Meal Plan and Beginner's Guide</h1>
                    <p class="small">
                        Numerous studies have now shown that the Mediterranean diet can cause weight loss and help prevent many diseases.
                    </p>
                    <p class="writer">By Kris Gunnars, BSc    April 18, 2020</p>
                    <img src="../images/mediterranean_diet_article.jpg" class="img-fluid" alt="Image of food">
                    <p class="small">
                    ...
                    <p class="bullets">• Eat: Vegetables, fruits, nuts, seeds, legumes, potatoes, whole grains, breads, herbs, spices, fish, seafood and extra virgin olive oil.
                        • Eat in moderation: Poultry, eggs, cheese and yogurt.
                        •  Eat only rarely: Red meat.
                        •  Don't eat: Sugar-sweetened beverages, added sugars, processed meat, refined grains, refined oils and other highly processed foods.
                    </p>
                    <p class="big">Avoid These Unhealthy Foods</p>
                    <p class="bullets">• Added sugar: Soda, candies, ice cream, table sugar and many others.
                    ...
                    <p class="bullets">• Vegetables: Tomatoes, broccoli, kale, spinach, onions, cauliflower, carrots, Brussels sprouts, cucumbers, etc.
                    ...
                    <p class="small">Whole, single-ingredient foods are the key to good health.</p>
                    <p class="big">What to Drink</p>
                    <p class="small">
                    ...
                    <p class="big">A Mediterranean Sample Menu for 1 Week</p>
                    <p class="small">
       ...
       <hr class="my-4">
            <div class="categories">
               ...
               <div class="b1">
                <div class="b2">
                   <a href="vegetarian-diet.php"> 
                       <img src="../images/vegetarian.jpg" class="img-fluid" alt="Image of a mediterranean diet meal">
                   </a>
                </div>
                 <h2><a href="vegetarian-diet.php">The Vegetarian Diet: A Beginner's Guide and Meal Plan</a></h2>
                 <p class="small">
                    This article provides a beginner's guide to the vegetarian diet, including a sample meal plan for one week.
                 </p>
                 <p class="writer">By Rachael Link, MS, RD</p>
           </div>
