<?php require '../article_navbar.php'; ?>
        <div class="conteiner">
            <div class="categories">
                <h1 class="header"> Diet</h1>
                <div class="article">
                    <h1>Top 10 healthful fruits</h1>
                    <p class="small">
                    ...
                    <img src="../images/fruits2.jpg" class="img-fluid" alt="Image of fruits">
                    <p class="small">
                    ...
                    <p class="big">1. Lemons</p>
                    <p class="small">
                        Lemons are a citrus fruit that people often use in traditional remedies because of their health benefits. Like other citrus fruits, they contain vitamin C and other antioxidants. <br><br>
                        Antioxidants are essential for human health. These compounds mop up free radicals in the body that can damage the body’s cells and lead to diseases, such as cancers. <br> <br>
                        Researchers believe that the flavonoids in lemon and other citrus fruits have antibacterial, anticancer, and antidiabetic properties.<br> <br>
                        Citrus fruits, including lemons, contain active components called phytochemicals that benefit health. These include:<br>
                         <ul>
                            <li>vitamin C</li>
                            <li>folic acid</li>
                            <li>potassium</li>
                        ...
                        <br><br><strong>How to eat lemons</strong>How to eat lemons <br>
                    ...
                    <p class="big">2. Strawberries</p>
                    <p class="small">
                        Strawberries are a juicy, red fruit with a high water content. The seeds provide plenty of dietary fiber per serving. Strawberries contain many healthful vitamins and minerals.<br> <br>Of particular note, they contain anthocyanins, which are flavonoids that can help boost heart health. The fiber and potassium in strawberries can also support a healthy heart.
                        <br><br>In one study, women who ate 3 or more servings per week of strawberries and blueberries — which are both known for their high anthocyanin content — had a lower risk of having a heart attack than those with lower intake.<br><br>
                    ...
                    <br>
                        <ul>
                            <li>17 calories</li>
                            <li>4.15 g carbohydrate</li>
                            <li>1.1 g of fiber</li>
                            <li>9 mg of calcium</li>
                            <li>7 mg of magnesium</li>
                            <li>83 mg of potassium</li>
                            <li>31.8 mg of vitamin C</li>
                        </ul>
                        Strawberries also contain thiamin, riboflavin, niacin, folate, and vitamins B-6, A and K.
                        <br><br><strong>How to eat strawberries</strong><br>
                    ...
                    <p class="small">
                        ...
                        <br><br>A medium banana also contains the following nutrients:
                        <ul>
                            <li>1.29 g protein</li>
                            <li>6 mg calcium</li>
                            <li>32 mg magnesium</li>
                            <li>10.3 mg vitamin C</li>
                        </ul>
                        <strong>How to eat bananas</strong><br>
                    ...
                    <img src="../images/lime.jpg" class="img-fluid" alt="Image of limes">
                    <p class="big"> 4. Limes</p>
                    <p class="small">
                        Limes are a sour citrus fruit that provide a range of health benefits.<br><br>Like other citrus fruits, limes provide a healthful dose of vitamin C. They also have similar health benefits, antibacterial, and antioxidant properties.<br><br>
                        The juice of one lime provides the following nutrients:
                        <ul>
                            <li>11 calories</li>
                            <li>3.7 g carbohydrate</li>
                            <li>6 g calcium</li>
                            <li>4 mg magnesium</li>
                            <li>51 mg potassium</li>
                            <li>13.2 mg vitamin C</li>
                        </ul>
                        <strong>How to eat limes</strong><br>
                    ...
                    <p class="big">5.Grapefruit</p>
                    <p class="small">
                        Grapefruits are sour fruits full of health-inducing vitamins and minerals. Grapefruits can be pink, red, or white.
                        <br><br>Half a grapefruit contains the following nutrients:
                        <ul>
                            <li>52 calories</li>
                            <li>13.11 g carbohydrate</li>
                            <li>2.0 g fiber</li>
                            <li>27 g calcium</li>
                            <li>11 g magnesium</li>
                            <li>166 g potassium</li>
                            <li>38.4 g vitamin C</li>
                        </ul>
                        ...
                        <br><br>Some research from this review suggests that grapefruit furanocoumarins may have anticancer properties, which may be especially effective against breast cancer, skin cancer, and leukemia. Researchers still need to carry out more studies on animals and humans to confirm these properties. <br><br>People may wish to see a doctor before adding grapefruit to their diet, as it can interact with certain medications.
                        <strong>How to eat grapefruit</strong><br>
                    ...
                    <img src="../images/blackberries.jpg" class="img-fluid" alt="Image of blackberries">
                    <p class="big">6. Blackberries</p>
                    <p class="small">
                        Like other berries, blackberries contain health-boosting anthocyanins.<br><br> 
                        ...
                        <ul>
                            <li>31 calories</li>
                            <li>6.92 g carbohydrate</li>
                            <li>3.8 g fiber</li>
                            <li>21 mg calcium</li>
                            <li>14 mg magnesium</li>
                            <li>117 mg potassium</li>
                            <li>15.1 mg vitamin C</li>
                        </ul>
                        <strong>How to eat blackberries</strong><br>
                        People can eat blackberries fresh, add them to yogurt for breakfast or dessert, or add frozen blackberries to smoothies.
                    </p>
                    <p class="big">7. Apples</p>
                    <p class="small">
                        ...
                        <br><br>One medium apple contains the following nutrients:
                        <ul>
                            <li>95 calories</li>
                            <li>25.13 g of carbohydrate</li>
                            <li>4.4 g of fiber</li>
                            <li>195 mg of potassium</li>
                            <li>11 mg calcium</li>
                            <li>8.4 mg vitamin C</li>
                        </ul>
                        ...
                        <br><br>
                        <strong>How to eat apples</strong><br>
                    ...
                    <p class="small">
                        ...
                        <br><br>One raw pomegranate contains:
                        <ul>
                            <li>234 calories</li>
                            <li>52.73 g of carbohydrate</li>
                            <li>11.3 g of fiber</li>
                            <li>666 mg of potassium</li>
                            <li>28 mg calcium</li>
                            <li>28.8 mg vitamin C</li>
                        </ul>
                        ...
                        <br><br>
                        <strong>How to eat pomegranate</strong><br>
                    ...
                    <p class="small">
                        ...
                        <br><br>Pineapples contain manganese, which the body uses to build bone and tissue. A medium slice of pineapple also contains the following nutrients:
                        <ul>
                            <li>42 calories</li>
                            <li>11.02 g of carbohydrate</li>
                            <li>1.2 g of fiber</li>
                            <li>92 mg of potassium</li>
                            <li>40.2 mg calcium</li>
                            <li>11 mg vitamin C</li>
                        </ul>
                        Read more about the benefits of pineapple, the pineapple juice, and potential bromelain benefits.
                        <br><br>
                        <strong>How to eat pineapple</strong><br>
                    ...
                    <img src="../images/orange_juice.jpg" class="img-fluid" alt="Image of orange juice">
                    <p class="big">10. Oranges</p>
                    <p class="small">
                        Oranges are a sweet, round citrus fruit packed with vitamins and minerals.<br> <br>Oranges are among the richest sources of vitamin C, with one medium fruit providing 117 percent of a person’s daily value of vitamin C.
                        <br><br>A 141 g orange also contains the following nutrients:<br>
                        <ul>
                            <li>65 calories</li>
                            <li>16.27 g carbohydrate</li>
                            <li>1.1 g of fiber</li>
                            <li>3.4 g of fiber</li>
                            <li>61 mg of calcium</li>
                            <li>14 mg of magnesium</li>
                            <li>238 mg of potassium</li>
                            <li>63.5 mg of vitamin C</li>
                        </ul>
                        ...
                        <br><br>The human body cannot make vitamin C itself, so people need to get this vitamin from their diet.Oranges also contain high levels of pectin, which is a fiber that can keep the colon healthy by binding to chemicals that can cause cancer and removing them from the colon.
                        <br><br>Oranges also provide the following healthful vitamins:
                        <br>
                        ...
                        <br>
                        <br>
                        <strong>How to eat oranges</strong><br>
       ...
       <hr class="my-4">
            <div class="categories">
                <h1 class="header"> More From Diet</h1>
                <div class="b1">
                    <div class="b2">
                       <a href="./eating-healthy.php"> 
                           <img src="../images/eating_healthy.jpg" class="img-fluid" alt="Image of a flower above a belly">
                       </a>
                    </div>
                     <h2><a href="./eating-healthy.php">What are the benefits of eating healthy?</a></h2>
                     <p class="small">
                      In this article, we look at the top 10 benefits of a healthful diet, as well as the evidence behind them.
                     </p>
                     <p class="writer">By Cathleen Crichton-Stuart</p>
               </div>

               <div class="b1">
                <div class="b2">
                   <a href="./waterbenefits.php"> 
                       <img src="../images/glass_of_water2.jpg" class="img-fluid" alt="Image of a bottle of water">
                   </a>
                </div>
                 <h2><a href="./waterbenefits.php">The Health Benefits of Water</a></h2>
                 <p class="small">
                    We all need water to survive, but how exactly does it help?
                 </p>
                 <p class="writer">By Alan Drake</p>
                </div>
        </div>
