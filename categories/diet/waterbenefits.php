<?php require '../article_navbar.php'; ?>
        <div class="conteiner">
            <div class="categories">
                ...
                <div class="article">
                    <h1>The Health Benefits of Water</h1>
                    <p class="small">
                        We all need water to survive, but how exactly does it help?
                    </p>
                    <p class="writer">By Jen Laskey    March 17, 2020</p>
                    <img src="../images/water.jpg" class="img-fluid" alt="Image of a bottle of water">
                    <p class="small">
                    ...
                    <p class="big"> Water Protects Your Tissues, Spinal Cord, and Joints</p>
                    <p class="small">
                    ...
                    <p class="big">Water Helps Your Body Remove Waste</p>
                    <p class="small">
                    ...
                    <p class="big">Water Aids in Digestion</p>
                    <p class="small">
                    ...
                    <p class="big">Water Prevents You From Becoming Dehydrated</p>
                    <p class="small">
                    ...
                    <p class="big">How Much Water Do You Need?</p>
                    <p class="small">
