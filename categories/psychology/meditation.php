<?php require '../article_navbar.php'; ?>
        <div class="conteiner">
            <div class="categories">
                <h1 class="header"> Psychology</h1>
                <div class="article">
                    <h1>5 Health Benefits of Daily Meditation</h1>
                    <img src="../images/meditation2.jpg" class="img-fluid" alt="Image of a girl meditating">
                    <p class="small">
                    ...
                    <p class="writer">by Madhuleena Roy Chowdhury
                        <br>posted on PositivePsychology
                    </p>
                    <p class="small">
                    ...
                    <p class="big"> A Look at the Benefits of Meditation</p>
                    <p class="small">
                    ...
                    <p class="big">1. Meditation enhances empathy</p>
                    <p class="small">
                    ...
                    <p class="big">2. Meditation improves cognition</p>
                    <p class="small">
                    ...
                    <p class="big">3. Meditation is a natural stress stabilizer</p>
                    <p class="small">
                    ...
                    <p class="big">4. Meditation promotes emotional health and well-being</p>
                    <p class="small">
                    ...
                    <p class="big">5. Meditation increases attention by inducing a state of flow</p>
                    <p class="small">
                    ...
                    <p class="big">What Does the Latest Research and Science Show?</p>
                    <p class="small">
                    ...
                    <p class="big">1. Meditation and Pain</p>
                    <p class="small">
                    ...
                    <p class="big">2. Meditation and diseases</p>
                    <p class="small">
                        ...
                        <ul>
                            ...
                            <li>Pain and fibromyalgia in teenagers.</li>
                            <li>Beginners and regular gned to meditation sessions rather than when they received alternate forms of therapy.</li>
                            <li>Migraine, headaches, and hypertensive conditions.</li>
                            <li>Psoriasis.</li>
                    ...
                    <p class="big">3. Meditation and Irritable Bowel Syndrome (IBS)</p>
                    <p class="small">
                    ...
                    <img src="../images/meditation-inside.jpg" class="img-fluid" alt="Image of a girl meditating">
                    <p class="big">Interesting Studies</p>
                    <p class="big">1. Future Directions in Meditation Science</p>
                    <p class="small">
                    ...
                    <p class="big">2. Cognitive Impact of Meditation</p>
                    <p class="small">
                    ...
                    <p class="big">3. Benefits of Meditation as a Psychotherapy</p>
                    <p class="small">
                        One study on the therapeutic qualities of meditation revealed that:
                        <ul>
                            <li>Regular practitioners who participated in the retreat without any pay were more self-content than non-meditators.</li>
                            <li>Beginners who practiced meditation for 1-2 months showed improvement in physical and mental health than non-meditators who practiced for the same duration.</li>
                            <li>Beginners and regular meditators showed increased signs of happiness and heightened self-esteem when they were randomly assigned to meditation sessions rather than when they received alternate forms of therapy.</li>
                        </ul>
                    </p>
                    <p class="big">4. Meditation and Well-being</p>
                    <p class="small">
                    ...
                    <p class="big">5 Proven Health Benefits of a Daily Practice</p>    
                    <p class="big">1. More fitness</p>   
                    <p class="small">
                    ...
                    <p class="big">4. Reduced chances of age-related memory loss</p>
                    <p class="small">
                    ...
                    <p class="big">5. Better prognosis for addiction</p>
                    <p class="small">
       ...
       <hr class="my-4">
            <div class="categories">
                <h1 class="header"> More From Psychology</h1>
                <div class="b1">
                    <div class="b2">
                       <a href="./diet&mental.php"> 
                           <img src="../images/diet_mental_health.jpg" class="img-fluid" alt="Image of a girl eating an apple">
                       </a>
                    </div>
                     <h2><a href="./diet&mental.php">Diet and mental health</a></h2>
                     <p class="small">
                     ...
                     <p class="writer">By Mental Health Organisation</p>
               </div>

               <div class="b1">
                <div class="b2">
                   <a href="./breathing.php"> 
                       <img src="../images/breath.jpg" class="img-fluid" alt="Image of a girl breathing">
                   </a>
                </div>
                 <h2><a href="./breathing.php">How Breathing Calms Your Brain</a></h2>
                 <p class="small">
                    Research points to a wealth of ways controlled breathing benefits the brain
                 </p>
                 <p class="writer">By David DiSalvo</p>
           </div>
