<?php require '../article_navbar.php'; ?>
        <div class="conteiner">
            <div class="categories">
                ...
                <div class="article">
                    <h1>How Breathing Calms Your Brain</h1>
                    <p class="writer">By David DiSalvo
                        <br> Neuronarrative <br>Posted on Psychology Today Dec 31, 2017</p>
                    <img src="../images/breath2.jpg" class="img-fluid" alt="Image of a girl breathing">
                    <p class="small">
                    ...
                    <p class="big">Controlling your breathing calms your brain.</p>
                    <p class="small">
                    ...
                    <p class="big"> Breathing regulates your blood pressure.</p>
                    <p class="small">
                    ...
                    <p class="big">Counting breaths taps into the brain’s emotional control regions.</p>
                    <p class="small">
                    ...
                    <p class="big">The rhythm of your breathing affects memory.</p>
                    <p class="small">
                    ...
                    <p class="big">Controlled breathing may boost the immune system and improve energy metabolism.</p>
                    <p class="small">
       ...
       <hr class="my-4">
            <div class="categories">
              ...
              <div class="b1">
                  <div class="b2">
                     <a href="./exercise.php"> 
                         <img src="../images/exercise.jpg" class="img-fluid" alt="Image of a girl running">
                     </a>
                  </div>
                   <h2><a href="./exercise.php">The exercise effect</a></h2>
                   <p class="small">
