<?php require '../article_navbar.php'; ?>
        <div class="conteiner">
            <div class="categories">
                ...
                <div class="article">
                    <h1>Overcoming Depression</h1>
                    <img src="../images/depression2.jpg" class="img-fluid" alt="Image of a sad girl">
                    <p class="small">
                    ...
                    <p class="writer">By The American Psychological Association (Laura Mufson, PhD, Lynn Bufka, PhD, and C. Vaile Wright).
                       <br> Published October 2016</p>
                    <p class="big">Understanding Depression</p>
                    <p class="small">
                        ...
                        <ul>
                          <li>Prolonged sadness or feelings of emptiness.</li>
                          ...
                          <li>Chronic pain, headaches or stomachaches.</li>
                    ...
                    <p class="big"> Treatment for Depression</p>
                    <p class="small">
                    ...
                    <p class="big">Seeing a Psychologist About Depression</p>
                    <p class="small">
                        ...
                        <ul>
                          <li>Pinpoint life events that contribute to their depression and help them find ways to change, accept or adapt to those situations..</li>
                          <li>Set realistic goals for the future.</li>
                          <li>Identify distorted thought processes or unhelpful behaviors that contribute to feelings of hopelessness and helplessness.</li>
                          <li>Develop skills to cope with symptoms and problems, and identify or prevent future episodes of depression.</li>
                        </ul> 
                    ...
                    <p class="big">Depression in Children and Adolescents</p>
                    <p class="small">
                        ...
                        <br>According to the Heart and Stroke Foundation of Canada, up to 80 percent of cases of premature heart disease and stroke can be prevented by making lifestyle changes, such as increasing levels of physical activity and eating healthfully.
                        <br>
                        <br>Adolescents are often moody. But if your child is extremely irritable, has ongoing problems with motivation, or has persistent sadness that lasts two weeks or more, it's a good idea to have him or her evaluated for depression.
                        <br>
                        <br>
                        ...
                        <br>
                        <br>While antidepressant medications can be effective for children and adolescents, they can have side effects in young people, including an increased risk of suicidal thoughts. For that reason, many parents and healthcare providers prefer to try treating children with psychotherapy first. Both CBT and IPT are effective treatments for young people with depression. Studies also show that a combination of antidepressant medication and cognitive behavior therapy is highly effective in treating youth depression.
                        <br>
                </div>
            </div>
        </div>
                ...
                <div class="b1">
                    <div class="b2">
                       <a href="./meditation.php"> 
                           <img src="../images/meditation.jpg" class="img-fluid" alt="Image of a girl meditating">
                       </a>
                    </div>
                     <h2><a href="./meditation.php">5 Health Benefits of Daily Meditation</a></h2>
                     <p class="small">
                     ...
                     <p class="writer">By Madhuleena Roy Chowdhury</p>
               </div>
