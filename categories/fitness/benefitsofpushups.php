<?php require '../article_navbar.php'; ?>
        <div class="conteiner">
            <div class="categories">
                ...
                <div class="article">
                  <h1>10 Benefits Of Push Ups</h1>
                  <p class="small">We all have done, more or less, some push ups in our workout routine.
                    But do we know what are their major benefits for our body?
                  </p>
                  <p class="writer">By keepinspiring.me</p>
                  <!-- TOCHECK -->
                  <img src="../images/push_ups2.jpg" class="img-fluid" alt="Image of Man Doing Push-Ups">
                  <p class="small">
                    Push ups are perhaps one of the easiest exercise movements. The standard push up activates 
                    nearly <strong>every muscle in your body</strong>, which yields far more than toned muscles and increased 
                  ...
                  <br><br>
                  <p class="big">1. Increase Functional Strength via Full Body Activation</p>
                  <p class="small">
                    ...
                    the top benefits of pushups. As you engage in this exercise, literally <strong>every major muscle in your 
                    body is called upon to execute the movement.</strong>
                    <br>
                  ...
                  <br>
                  <p class="big">2. Muscle Stretching for Health and Vitality</p>
                  <p class="small">
                    ...
                    <strong>improves your flexibility, which helps prevent injuries</strong>, but a well-stretched muscle feature a solid 
                    and attractive appearance.
                  </p>
                  <br>
                  <p class="big">3. Enhance Your Cardiovascular System</p>
                  <p class="small">
                    ...
                    oxygen-rich blood to muscle tissue. Ultimately, this activity results in <strong>an effective cardiovascular 
                    exercise</strong>, which supports heart health and promotes the reduction of stored body fat.
                  </p>
                  <br>
                  <p class="big">4. Increase Whole Body Muscle Definition – HGH Promotion</p>
                  <p class="small">
                    ...
                    <br>
                    By calling upon such a wide array of muscles, <strong>the production of HGH is triggered</strong>, which ultimately 
                    results in muscle hypertrophy – or <strong>muscle growth.</strong> To maximize push up benefits, you must incorporate 
                    this exercise into your regular strength training program.
                  </p>
                  <br>
                  <p class="big">5. Protect Your Shoulders from Injury</p>
                  <p class="small">
                    ...
                    <br>
                    The standard push up has been found to be among <strong>the most effective ways to safeguard your shoulder 
                    joints from injury;</strong> especially in older adults. Because push ups call upon stabilizing muscles, 
                  ...
                  <br>
                  <p class="big">6. Improve Your Posture</p>
                  <p class="small">
                    One of the most common reasons for <strong>a lack of proper posture is weak core muscles.</strong> In order to properly 
                  ...
                  <br>
                  <p class="big">7. Prevent Lower Back Injuries</p>
                  <p class="small">
                    ...
                    <br>
                    By developing strength in this specific portion of your body, <strong>you cultivate muscles responsible for 
                    reducing lower back pressure</strong>, which is imperative to prevent and treat low back injuries.
                  </p>
                  <br>
                  <p class="big">8. Save Time While Cultivating a Strong Body</p>
                  <p class="small">
                    ...
                    time for a traditional strength training or cardiovascular workout, <strong>if you have five minutes you can 
                    achieve a full-body workout with push ups.</strong> Want to add variation to this swift and potent exercise movement? 
                  ...
                  <br>
                  <p class="big">9. No Cost for a Full Body Workout</p>
                  <p class="small">
                    Although you may have a desire to join a world-class gym, their monthly dues may not fit in your tight 
                    budget. Thankfully, <strong>you don’t need an expensive gym membership</strong> – or even any equipment – to obtain an 
                  ...
                  <br>
                  <p class="big">10. Increase Testosterone and Reduce Osteoporosis Development</p>
                  <p class="small">
                    ...
                    several studies suggest <strong>the simple movements within a standard push up promotes testosterone production</strong>, which 
                    is essential for a healthy body in both men and women.
                    <br>
                    Moreover, weight bearing exercises, such as the standard push up, <strong>supports stronger, more dense bones.</strong> This 
        ...
        <hr class="my-4">
            <div class="categories">
                ...
                <div class="b1">
                    <div class="b2">
                       <a href="./daily-planking.php"> 
                           <img src="../images/plank.jpg" class="img-fluid" alt="image">
                       </a>
                    </div>
                     <h2><a href="./daily-planking.php">Benefits of doing plank in daily basis</a></h2>
                     <p class="small">
